...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<MusteriToplamSatinAlim> MusteriToplamSatinAlims { get; set; }
    ...
    public virtual DbSet<SatisiYapilmamisUrunler> SatisiYapilmamisUrunlers { get; set; }
    ...
    public virtual DbSet<UruneGoreSatisRaporu> UruneGoreSatisRaporus { get; set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=MERT\\SQLEXPRESS;Database=Northwind;User ID=OzgurZaman;Password=2119;Trust Server Certificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<MusteriToplamSatinAlim>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("Musteri_Toplam_Satin_Alim");

            entity.Property(e => e.CompanyName).HasMaxLength(40);
            entity.Property(e => e.Country).HasMaxLength(15);
            entity.Property(e => e.ToplamSatınAlımFiyatı)
                .HasColumnType("money")
                .HasColumnName("Toplam Satın Alım Fiyatı");
        });
        ...
        modelBuilder.Entity<SatisiYapilmamisUrunler>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("Satisi_Yapilmamis_Urunler");
        ...
        modelBuilder.Entity<UruneGoreSatisRaporu>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("Urune_Gore_Satis_Raporu");

            entity.Property(e => e.BrütKar)
                .HasColumnType("money")
                .HasColumnName("Brüt Kar");
            entity.Property(e => e.ProductName).HasMaxLength(40);
            entity.Property(e => e.ToplamMaliyet)
                .HasColumnType("money")
                .HasColumnName("Toplam Maliyet");
            entity.Property(e => e.ToplamSatışTutarı)
                .HasColumnType("money")
                .HasColumnName("Toplam Satış Tutarı");
            entity.Property(e => e.ToplamÜrünAdedi).HasColumnName("Toplam Ürün Adedi");
        });
