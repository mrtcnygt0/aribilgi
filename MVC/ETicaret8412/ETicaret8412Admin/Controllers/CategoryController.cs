...
public class CategoryController : Controller
{
    ...
    public CategoryController(_8412dbContext context)
    {
        _context = context;
    }
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(int? id, [Bind("CategoryId,CategoryName,Description,Products")] Category category)
    {
